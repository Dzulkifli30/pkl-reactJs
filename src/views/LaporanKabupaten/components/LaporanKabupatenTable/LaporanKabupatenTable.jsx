...
import { urlLaporanKab,urlProv,urlShowKab } from '../../../../kumpulanUrl';
...
const LaporanKabupatenTable=props => {
  ...
  return <div class="form-group">
      ...
      <Button onClick={(e) => handleOpen(e, [], "Tambah Kabupaten")}>
        ...
        <Button className={classes.searchInput} onClick={(e) => handleOpen(e, [], "Tambah Kabupaten")}>
      ...
      <CardContent className={classes.content}>
        <PerfectScrollbar>
          ...
          <div className={classes.inner}>
            <DataTable
            font="Poppins"
              title="Laporan Wilayah Kabupaten"
